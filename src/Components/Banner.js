               ...
               <div className="col-lg-6 col-md-12 col-sm-12 col-12 banner__left">
                   ...
                   <div className="row banner__left__footer">
                       <div className="col-12 d-flex banner__desktop__footer">
                           ...
                           <button type="button" className="btn btn-light d-flex align-items-center">Узнать больше <img src="./images/right_arrow.svg" className="ml-3" alt="Eror" /></button>
                       </div>
                   </div>
               </div>
          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-12 banner__mobile__footer">
                   ...
                   <div className="row banner__left__footer">
                       <div className="col-12 d-flex mobile__btn">
                           ...
                           <button type="button" className="btn btn-light d-flex align-items-center btn__two">Узнать больше <img src="./images/right_arrow.svg" className="ml-3" alt="Eror" /></button>
                       </div>
                   </div>
               </div>
         </div>
